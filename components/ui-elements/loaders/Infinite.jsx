...
export const InfiniteLoader = () => {
  ...
  useEffect(() => {
    document.body.classList.add('infinite-loader');
    setTimeout(() => {
      setMessage(true);
    }, 4000);
    return () => {
      document.body.classList.remove('infinite-loader');
    };
  }, []);
  return (
		<>
				<main className='page-content'>
					...
					{message && <p className='container p-4 absolute inset-0 text-white -m-24'>Please wait, the content is still loading...</p>}
				</main>
	</>
	);
}