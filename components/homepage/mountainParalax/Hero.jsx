  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      if (
        ...
        gsap.to(secondSection, { backgroundColor: "green", duration: 0.5 });
      } else {
        gsap.to(secondSection, { backgroundColor: "peach", duration: 0.5 });
      }
    };
            ...
            >
              ...
              <div className="text">
                <h1 className="paralax-text relative z-50 uppercase to-black roboto flex flex-col leading-8 font-black mb-4">
                  Remco Stoeten <span>Front-end developer</span>
                </h1>
