	...
	return (
		<>
			<div className='fixed z-10 inset-0 overflow-y-auto'>
				...
				<div className='inline-block align-bottom  rounded-lg text-left overflow-hidden shadow-xl transform transition-all smsm:align-'>
					<div className='flex flex-col  items-left	'>
						<h3 className='text-lg leading-6 font-medium text-gray-900 ml-2'>
							Checkout
						</h3>
						<p>
							Test card = 4242 keep repeating untill all fields
							are full with 42.
						</p>
					</div>
