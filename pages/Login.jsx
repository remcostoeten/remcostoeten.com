		...
		<div className='w-3/4 h-4/5 mx-auto my-8 sm:w-3/4 sm:h-4/5'>
			...
			<div
				...
				<div className='max-w-lg p-8 sm:pb-4 bg-white rounded shadow-lg text-center sm:text-left'>
					...
					<p className='mt-2'>
						It has 52 different UI components, 7 landing pages, and
						8 inner pages prebuilt. And they are customizable!
					</p>
