			...
			<div className="flex p-4 h-full flex-col">
				<div className="">
					<div className="flex items-center">
						...
						<Icon
							path="res-react-dash-graph-range"
							className="w-4 h-4"
						/>
		...
		return (
			<div className="p-4 h-full">
				...
				<div className="flex mt-3 px-3 items-center justify-between bg-details rounded-xl w-36 h-12">
					...
					<Icon
						path="res-react-dash-chevron-right"
						className="w-4 h-4"
					/>
				</div>
			</div>
					...
					>
						...
						<animated.circle
							cx={dashOffset.interpolate(
								(x) =>
									350 +
									250 * Math.cos(map(x, 785.4, 0, pi, tau)),
							)}
							cy={dashOffset.interpolate(
								(x) =>
									350 +
									250 * Math.sin(map(x, 785.4, 0, pi, tau)),
							)}
							r="12"
							fill="#fff"
						/>
